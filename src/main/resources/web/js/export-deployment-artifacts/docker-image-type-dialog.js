...
define(['require', 'lodash', 'jquery'],
    function (require, _, $) {
        ...
        var DockerImageTypeDialog = function (options) {
            this.dockerNameMissingErrorMessage = options.templateHeader.find("#missing-docker-build-type-error-message");
            this.dockerNameInUpperError = options.templateHeader.find("#missing-docker-build-type-upper-error");
            this.templateContainer = options.templateHeader;
            this.dockerImageNameForm = options.templateHeader.find('#docker-image-name-form')
        };
