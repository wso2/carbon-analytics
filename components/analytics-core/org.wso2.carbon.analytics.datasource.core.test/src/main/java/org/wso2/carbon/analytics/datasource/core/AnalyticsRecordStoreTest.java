...
public class AnalyticsRecordStoreTest {
    ...
    public void testTableSetGetSchema() throws AnalyticsException {
        ...
        columns.put("name", cd1);
        ColumnDefinition cd2 = new ColumnDefinition();
        cd2.setType(AnalyticsSchema.ColumnType.STRING);
        columns.put("age", cd2);
        ColumnDefinition cd3 = new ColumnDefinition();
        cd3.setType(AnalyticsSchema.ColumnType.STRING);
        columns.put("weight", cd3);
        ColumnDefinition cd4 = new ColumnDefinition();
        cd4.setType(AnalyticsSchema.ColumnType.STRING);
        columns.put("something1", cd4);
        ColumnDefinition cd5 = new ColumnDefinition();
        cd5.setType(AnalyticsSchema.ColumnType.STRING);
        columns.put("something2", cd5);
        ColumnDefinition cd6 = new ColumnDefinition();
        cd6.setType(AnalyticsSchema.ColumnType.STRING);
        columns.put("something3", cd6);
