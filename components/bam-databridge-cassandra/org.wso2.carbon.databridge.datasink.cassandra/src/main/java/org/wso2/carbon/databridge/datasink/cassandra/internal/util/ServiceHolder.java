...
public class ServiceHolder {
    ...
    private static BAMEventSubscriber bamIndexSubscriber;
    ...
    public static BAMEventSubscriber getBamIndexSubscriber() {
        return bamIndexSubscriber;
    }

    public static void setBamEventSubscriber(BAMEventSubscriber bamIndexSubscriber) {
        ServiceHolder.bamIndexSubscriber = bamIndexSubscriber;
    }
