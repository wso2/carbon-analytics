 ...
 *
 */
package org.wso2.carbon.analytics.datasource.rdbms.oracle;
...
/**
 * Oracle test implementation of {@link AnalyticsDataServiceTest}.
 */
public class OracleAnalyticsDataServiceTest extends AnalyticsDataServiceTest {

    @BeforeClass
    public void setup() throws NamingException, AnalyticsException, IOException {
        GenericUtils.clearGlobalCustomDataSourceRepo();
        System.setProperty(GenericUtils.WSO2_ANALYTICS_CONF_DIRECTORY_SYS_PROP, "src/test/resources/conf4");
        System.setProperty("carbon.config.dir.path", "src/test/resources/conf4");
