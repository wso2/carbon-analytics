 ...
 *
 */
package org.wso2.carbon.analytics.datasource.rdbms.postgre;
...
/**
 * Oracle test implementation of {@link org.wso2.carbon.analytics.datasource.core.AnalyticsDataServiceTest}.
 */
public class PostgreSQLAnalyticsDataServiceTest extends AnalyticsDataServiceTest {

    @BeforeClass
    public void setup() throws NamingException, AnalyticsException, IOException {
        GenericUtils.clearGlobalCustomDataSourceRepo();
        System.setProperty(GenericUtils.WSO2_ANALYTICS_CONF_DIRECTORY_SYS_PROP, "src/test/resources/conf6");
        System.setProperty("carbon.config.dir.path", "src/test/resources/conf6");
