...
public class AnalyticsRecord {
	...
	private static final Log log = LogFactory.getLog(AnalyticsRecord.class);
	...
	public static AnalyticsRecord fromDocument(Document document, String tableName, Integer tenantId) {
		...
		if (result.getId() == null) {
			log.info("Document with ID NULL: " + document.toJson() + " collection: "
					+ GenericUtils.generateTableUUID(tenantId, tableName));
		}
