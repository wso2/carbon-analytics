                ...
                <div>
                    ...
                    <Router>
                        <div>
                            ...
                            <Route exact path='*/sp-status-dashboard/worker/:id/siddhi-apps/:appName' component={AppSpecific}/>
                            ...
                            <Route exact path='/sp-status-dashboard/worker/history/:id/more' component={WorkerHistoryMore}/>
                        </div>
                    </Router>
                </div>
            </MuiThemeProvider>
