...
export default class AppTable extends React.Component {
    ...
    renderRow(row) {
        ...
        // console.log({mem: row.appMetricsHistory.memory.data})
        return (
            <TableRow >
                    ...
                    row.appMetricsHistory.throughput.data.length !== 0 ?
                        (<TableRowColumn>
                            ...
                            <Link style={{textDecoration: 'none'}}
                                  ...
                                  + "/" + row.isStatEnabled}>
                                <div style={{width: '50%', float: 'right', height: '100%'}}>
                                    {/*<VizG data={[[1511170170033,7.2792824E7],[1511170230033,7.282084E7],[1511170290033,7.2852312E7],[1511170350033,7.2886776E7],[1511170410033,7.2897288E7]]} metadata={metadata}*/}
                                          {/*config={sparkLineConfig}*/}
                                          {/*yDomain={DashboardUtils.getYDomain([[1511170170033,7.2792824E7],[1511170230033,7.282084E7],[1511170290033,7.2852312E7],[1511170350033,7.2886776E7],[1511170410033,7.2897288E7]])}/>*/}
