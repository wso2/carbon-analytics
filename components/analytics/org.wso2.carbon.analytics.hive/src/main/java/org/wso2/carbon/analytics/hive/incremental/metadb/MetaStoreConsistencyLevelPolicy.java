 ...
 */
public class MetaStoreConsistencyLevelPolicy implements ConsistencyLevelPolicy {

    private final HConsistencyLevel readConsistency;
    private final HConsistencyLevel writeConsistency;


    public MetaStoreConsistencyLevelPolicy(String readConsistency, String writeConsistency) {
