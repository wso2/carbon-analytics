            ...
            <form id="listScripts" name="listScripts" action="" method="POST">
                <table class="styledLeft">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="icon-link" style="background: url('../spark-management/images/edit.gif') no-repeat;"
                               href="addOrEditScript.jsp?scriptName=<%=aName%>">Edit</a>
                            <a class="icon-link"
                               href="executeScript.jsp?scriptName=<%=aName%>"
