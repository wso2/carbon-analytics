...
private[spark] class CoarseGrainedExecutorBackend2(
    driverUrl: String,
    executorId: String,
    hostPort: String,
    cores: Int,
...
private[spark] object CoarseGrainedExecutorBackend2 extends Logging {
  ...
  private def run(
    ...
    SparkHadoopUtil.get.runAsSparkUser { () =>
      ...
      env.actorSystem.actorOf(
        Props(classOf[CoarseGrainedExecutorBackend2],
