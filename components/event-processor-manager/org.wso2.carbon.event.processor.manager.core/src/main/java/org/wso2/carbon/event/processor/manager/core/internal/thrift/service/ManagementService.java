...
public class ManagementService {
  ...
  public interface Iface {
    ...
    public org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData takeSnapshot() throws org.wso2.carbon.event.processor.manager.core.internal.thrift.exception.InternalServerException, TException;

  }

  public interface AsyncIface {

    public void takeSnapshot(AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData recv_takeSnapshot() throws org.wso2.carbon.event.processor.manager.core.internal.thrift.exception.InternalServerException, TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class takeSnapshot_call extends org.apache.thrift.async.TAsyncMethodCall {
      public takeSnapshot_call(AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
      ...
      public org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData getResult() throws org.wso2.carbon.event.processor.manager.core.internal.thrift.exception.InternalServerException, TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class takeSnapshot<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, takeSnapshot_args, org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData> {
      ...
      public AsyncMethodCallback<org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData>() { 
      ...
      public void start(I iface, takeSnapshot_args args, AsyncMethodCallback<org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData> resultHandler) throws TException {
...
;
  ...
  public static class takeSnapshot_result implements org.apache.thrift.TBase<takeSnapshot_result, takeSnapshot_result._Fields>, java.io.Serializable, Cloneable, Comparable<takeSnapshot_result>   {
    ...
    public org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData success; // required
    public org.wso2.carbon.event.processor.manager.core.internal.thrift.exception.InternalServerException ise; // required
    ...
    public takeSnapshot_result setSuccess(org.wso2.carbon.event.processor.manager.core.internal.thrift.data.SnapshotData success) {
      this.success = success;
      return this;
    }
    ...
    public takeSnapshot_result setIse(org.wso2.carbon.event.processor.manager.core.internal.thrift.exception.InternalServerException ise) {
      this.ise = ise;
      return this;
    }
    ...
    public int compareTo(takeSnapshot_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetIse()).compareTo(other.isSetIse());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetIse()) {
