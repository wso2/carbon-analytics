...
public class TenantEventConfigData {
    ...
    private volatile static Map<Integer, InternalEventingConfigData> tenantEventingConfigDataMap;

    public static Map<Integer, InternalEventingConfigData> getTenantSpecificEventingConfigData() {
        if (tenantEventingConfigDataMap == null) {
            synchronized (TenantEventConfigData.class) {
                if (tenantEventingConfigDataMap == null) {
                    tenantEventingConfigDataMap = new HashMap<Integer, InternalEventingConfigData>();
                }
            }
        }
