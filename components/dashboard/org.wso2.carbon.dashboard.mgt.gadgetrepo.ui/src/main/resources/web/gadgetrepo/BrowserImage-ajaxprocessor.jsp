...
page import="org.wso2.carbon.dashboard.mgt.gadgetrepo.ui.GadgetRepoServiceClient"%><%@page
import="org.apache.axiom.om.util.Base64"%><%@page
...
page import="java.io.OutputStream"%><%
    ...
    if (request.getParameter("gadgetName") != null) {

        int imageId = Integer.parseInt(request.getParameter("imgID").substring(0,1));
		String gadgetName = request.getParameter("gadgetName");
        result = gadgetRepoServiceClient.getGadgetByName(gadgetName);
		try {
			byte[] imgData = null;
