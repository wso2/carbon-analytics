...
import org.wso2.analytics.recordstore.commons.AnalyticsConstants;
...
public class AnalyticsDataServiceConfiguration {
    ...
    private int recordsBatchSize = AnalyticsConstants.RECORDS_BATCH_SIZE;
    ...
    @XmlElement (name = "recordsBatchSize", defaultValue = "" + AnalyticsConstants.RECORDS_BATCH_SIZE)
