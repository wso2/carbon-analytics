...
<fmt:bundle basename="org.wso2.carbon.analytics.spark.ui.i18n.Resources">
    ...
    <script type="text/javascript">
        ...
        CARBON.showErrorDialog('Error while deleting the scripts <%=scriptName%>. <%=e.getFaultMessage().
    ...
    %>
    <script type="text/javascript">
        CARBON.showInfoDialog('Successfully removed the script: <%=scriptName%> and its scheduled for undeployment', function () {
            location.href = "listScripts.jsp";
        }, function () {
            location.href = "listScripts.jsp";
        });
