...
public class AnalyticsProcessorAdminException extends Exception {
    ...
    public AnalyticsProcessorAdminException(String message) {
        super(message);
        this.message = message;
    }

    public AnalyticsProcessorAdminException(String message, Throwable cause) {
        super(message, cause);
        this.message = message;
    }

    public AnalyticsProcessorAdminException(Throwable cause) {
        super(cause);
