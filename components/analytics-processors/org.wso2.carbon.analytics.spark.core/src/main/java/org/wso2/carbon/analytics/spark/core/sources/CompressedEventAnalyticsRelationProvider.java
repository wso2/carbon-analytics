...
public class CompressedEventAnalyticsRelationProvider implements RelationProvider, SchemaRelationProvider, Serializable {
    ...
    private static final Log log = LogFactory.getLog(CompressedEventAnalyticsRelationProvider.class);
     ...
     */
    @Override
    public CompressedEventAnalyticsRelation createRelation(SQLContext sqlContext, Map<String, String> parameters) {
