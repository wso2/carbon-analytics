...
/**
 * This class represents custom UDF type 10 adaptor
 */
public class UDF10Adaptor implements UDF10 {

    private static final long serialVersionUID = 7888342884155377673L;
    private static Log log = LogFactory.getLog(UDF10Adaptor.class);
    private Class<Object> udfClass;
    private String udfMethodName;
    private Class[] parameterTypes;

    public UDF10Adaptor(Class<Object> udfClass, String udfMethodName, Class[] parameterTypes)
    ...
    public Object call(Object o, Object o2, Object o3, Object o4, Object o5, Object o6, Object o7,
        ...
        try {
            if (Modifier.isStatic(udfMethod.getModifiers())) {
                return udfMethod.invoke(null, o, o2, o3, o4, o5, o6, o7, o8, o9, o10);
            } else {
                Object udfInstance = udfClass.newInstance();
                return udfMethod.invoke(udfInstance, o, o2, o3, o4, o5, o6, o7, o8, o9, o10);
            }
