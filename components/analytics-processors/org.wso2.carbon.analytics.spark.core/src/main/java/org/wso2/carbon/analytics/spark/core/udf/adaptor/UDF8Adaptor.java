...
/**
 * This class represents custom UDF type 8 adaptor
 */
public class UDF8Adaptor implements UDF8 {

    private static final long serialVersionUID = 1200374668845809408L;
    private static Log log = LogFactory.getLog(UDF8Adaptor.class);
    private Class<Object> udfClass;
    private String udfMethodName;
    private Class[] parameterTypes;

    public UDF8Adaptor(Class<Object> udfClass, String udfMethodName, Class[] parameterTypes)
