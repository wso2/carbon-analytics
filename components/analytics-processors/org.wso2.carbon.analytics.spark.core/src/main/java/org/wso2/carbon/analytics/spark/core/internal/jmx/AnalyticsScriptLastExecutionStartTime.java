...
public class AnalyticsScriptLastExecutionStartTime implements AnalyticsScriptLastExecutionStartTimeMBean {
    ...
    @Override
    public long getScriptLastExecutionStartTime(int tenantId, String scriptName) {
        return AnalyticsScriptLastExecutionStartTimeHolder.get(AnalyticsScriptLastExecutionStartTimeHolder.generateId(tenantId, scriptName));
    }
}
