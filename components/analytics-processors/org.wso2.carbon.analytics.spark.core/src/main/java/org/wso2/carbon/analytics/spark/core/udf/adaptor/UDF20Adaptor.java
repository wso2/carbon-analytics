...
/**
 * This class represents custom UDF type 20 adaptor
 */
public class UDF20Adaptor implements UDF20 {

    private static final long serialVersionUID = 7933672596455985594L;
    private static Log log = LogFactory.getLog(UDF20Adaptor.class);
    private Class<Object> udfClass;
    private String udfMethodName;
    private Class[] parameterTypes;

    public UDF20Adaptor(Class<Object> udfClass, String udfMethodName, Class[] parameterTypes)
