...
public class AnalyticsConstants {
    ...
    public static final String DISABLE_ANALYTICS_EXECUTION_JVM_OPTION = "disable.analytics.execution";
    public static final String DISABLE_ANALYTICS_ENGINE_JVM_OPTION = "disable.analytics.engine";
