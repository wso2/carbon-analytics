...
public interface AnalyticsRecordStore {
     ...
     */
    void createTable(int tenantId, String tableName) throws AnalyticsDataSourceException;
     ...
     * @throws AnalyticsDataSourceException
     */
    boolean tableExists(int tenantId, String tableName) throws AnalyticsDataSourceException;
     ...
     * @throws AnalyticsDataSourceException
     */
    void deleteTable(int tenantId, String tableName) throws AnalyticsDataSourceException;
     ...
     * @throws AnalyticsDataSourceException
     */
    List<String> listTables(int tenantId) throws AnalyticsDataSourceException;
