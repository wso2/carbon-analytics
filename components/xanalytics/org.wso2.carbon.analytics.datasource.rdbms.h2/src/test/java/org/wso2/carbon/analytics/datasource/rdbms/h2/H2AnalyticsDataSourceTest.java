...
import org.wso2.carbon.analytics.datasource.rdbms.h2.H2AnalyticsDataSource;

/**
 * H2 database implementation of analytics data source tests.
 */
public class H2AnalyticsDataSourceTest extends AnalyticsDataSourceTest {
    ...
    public void setup(String url, String username, 
        ...
        H2AnalyticsDataSource ads = new H2AnalyticsDataSource();
        Map<String, Object> props = new HashMap<String, Object>();
        props.put("datasource", "DS");
        ads.init(props);
        this.init("H2AnalyticsDataSource", ads);
    }
