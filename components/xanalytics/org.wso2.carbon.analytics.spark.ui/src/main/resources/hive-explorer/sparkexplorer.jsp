...
<%--todo: this is a copy of the hive UI. IMPLEMENT ME!--%>
...
<script type="text/javascript">
    ...
    function saveScriptAfterChecking() {
        ...
        if(!validateTextForIllegal(document.getElementById('scriptName'))){
            var message = "Script name contains one or more illegal characters. Please enter a different script name to save";
            CARBON.showErrorDialog(message);
            return false;
        }
