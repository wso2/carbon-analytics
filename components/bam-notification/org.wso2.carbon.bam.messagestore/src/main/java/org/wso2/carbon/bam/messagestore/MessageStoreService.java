...
/**
 * This class represents a web service used to put/get persisted messages.
 */
public class MessageStoreService {
    ...
    public Message getData(String type) {
        return MessageStore.getInstance().getData(type);
    }
    
    public void clearData(String type) {
        MessageStore.getInstance().clearData(type);
    }
