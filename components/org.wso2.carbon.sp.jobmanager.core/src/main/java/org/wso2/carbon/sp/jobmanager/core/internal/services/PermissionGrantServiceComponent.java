...
public class PermissionGrantServiceComponent {
    ...
    protected void start(BundleContext bundleContext) {
        ...
        try {
            ManagerDeploymentConfig resolvedConfiguration =
                    ManagerDataHolder.getInstance().getManagerDeploymentConfig();
            RolesProvider rolesProvider = new RolesProvider(resolvedConfiguration);
            ManagerDataHolder.getInstance().setRolesProvider(rolesProvider);
            initPermission();
    ...
    private void initPermission() throws IdPClientException {
        ...
        List<Role> sysAdminRoles = ManagerDataHolder.getInstance()
        ...
        List<Role> devRoles = ManagerDataHolder
        ...
        List<Role> viwerRoles = ManagerDataHolder
    ...
    protected void setPermissionManager(PermissionManager permissionManager) {
        ...
        ManagerDataHolder.getInstance().setPermissionProvider(this.permissionProvider);
    }

    protected void unsetPermissionManager(PermissionManager permissionManager) {
        this.permissionProvider = null;
        ManagerDataHolder.getInstance().setPermissionProvider(null);
    }
