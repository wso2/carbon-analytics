...
public class PatternSequenceConfigGenerator {
    ...
    private StateElementConfig traverseAndGenerate(StateElement stateElement) {
        return null;
    }
    ...
    private StreamStateElementConfig generateStateElementConfig(StreamStateElement streamStateElement) {
        ...
        streamStateElementConfig.setId(basicSingleInputStream.getStreamReferenceId());
        ...
        if (basicSingleInputStream.getStreamHandlers().size() == 1) {
            if (basicSingleInputStream.getStreamHandlers().get(0) instanceof Filter) {
                ...
                streamStateElementConfig.setFilter(
        ...
        streamStateElementConfig.setWithin(
