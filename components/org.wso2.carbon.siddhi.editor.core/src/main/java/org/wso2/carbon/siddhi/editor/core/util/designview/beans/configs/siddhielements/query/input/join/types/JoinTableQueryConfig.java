...
/**
 * Represents a Join Table Query, for Siddhi Query's input
 */
public class JoinTableQueryConfig extends JoinQueryConfig {
    private JoinDirectionConfig left;
    private String joinType;
    private JoinDirectionConfig right;
    private String on;

    public JoinTableQueryConfig(JoinDirectionConfig left,
                                String joinType,
                                JoinDirectionConfig right,
                                String on) {
        super(JoinWithType.TABLE.toString());
        this.left = left;
