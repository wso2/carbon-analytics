...
public class AndOrPatternEventConfig extends PatternQueryEventConfig {
     ...
     */
    public AndOrPatternEventConfig() {
    ...
    public AndOrPatternEventConfig(boolean forEvery,
        ...
        super(PatternSequenceEventType.ANDOR.toString(), forEvery);
