...
package org.wso2.carbon.siddhi.editor.core.util.designview.designgenerator.generators.source;
...
/**
 * Generator to create SourceConfig
 */
public class SourceConfigGenerator {
    public SourceConfig generateSourceConfig() {
        // TODO implement
        throw new IllegalArgumentException("Unable to generate source config");
    }
...
//        SourceMap sourceMap = generateSourceMap(mapAnnotationContent);
        ...
        throw new IllegalArgumentException("Unable to generate stream definition configs");
    }

    private SourceMap generateSourceMap(String mapAnnotationContent) {
        // TODO: 4/6/18 implement
        throw new IllegalArgumentException("Unable to generate map annotation configs");
    }
}
