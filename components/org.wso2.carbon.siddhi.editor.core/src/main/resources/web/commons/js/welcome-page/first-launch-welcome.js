        ...
        var FirstLaunchWelcomePage = Backbone.View.extend({
            ...
            render: function () {
                ...
                var bodyUlQuickLinkContent = $('<ul class="quick-links col-md-12 col-lg-8">' +
                    '<li class="col-md-4"><a href="https://docs.wso2.com/display/SP410/Quick+Start+Guide"' +
                    ...
                    '<li class="col-md-4"><a href="https://docs.wso2.com/display/SP410/Tutorials"' +
                    'target="_blank"><i class="fw fw-text"></i>Tutorials</a></li>' +
                    '<li class="col-md-4"><a href="https://docs.wso2.com/display/SP410/Stream+Processor+Documentation"' +
