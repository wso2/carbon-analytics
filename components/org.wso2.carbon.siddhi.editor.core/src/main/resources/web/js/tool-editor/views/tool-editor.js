            ...
            /** @lends ServicePreview.prototype */
            {
                ...
                render: function () {
                    ...
                    var JSONString = "{" +
                        ...
                        "\"eventList\":{\"0\":{\"type\":\"andor\",\"forEvery\":true,\"leftEventReference\":\"12\",\"leftStreamName\":\"asc\",\"leftFilter\":\"11\",\"connectedWith\":\"and\",\"rightEventReference\":\"13\",\"rightStreamName\":\"asc\",\"rightFilter\":\"14\",\"within\":\"15\"},\"1\":{\"type\":\"notfor\",\"forEvery\":true,\"streamName\":\"asc\",\"filter\":\"321\",\"forDuration\":\"123\"},\"length\":2}},\"select\":{\"type\":\"user_defined\",\"value\":[{\"expression\":\"ewq\",\"as\":\"ewq\"}]},\"groupBy\":[],\"having\":\"eq\",\"outputRateLimit\":\"ewq\",\"queryOutput\":{\"type\":\"delete\",\"output\":{\"forEventType\":\"all\",\"on\":\"w\"},\"target\":\"asc\"},\"annotationList\":{}}," +
                        "\"length\":1},"+
                        "\"joinQueryList\":{}," +
                        "\"partitionList\":{}," +
                        "\"edgeList\":{" +
