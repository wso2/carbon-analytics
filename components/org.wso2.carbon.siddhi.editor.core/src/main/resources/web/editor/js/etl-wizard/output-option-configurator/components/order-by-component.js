        ...
        QueryOrderByComponent.prototype.render = function () {
            ...
            config.query.orderby.attributes.forEach(function (orderByOption) {
                container.find('#orderby-attribute-list')
                    .append(`
                        <div style="display: flex; background-color: #888; 
                            ...
                            <div style="width: 40%">
                                <button 
                                    id="${orderByOption.attribute.name}-sort" 
                                    style="background: #555; 
                                    min-width: 70px" 
                                    class="btn btn-default btn-sort"
                                >
                                    ${
                                        orderByOption.sort === 'asc' ? 
                                            `ASC&nbsp;<i class="fw fw-down">` 
                                            : `DESC&nbsp;<i class="fw fw-up">`
                                    }
                                    </i>
                                </button>
                                <button 
                                    id="${orderByOption.attribute.name}-delete"
