    ...
    function (require, $, _, log, Alerts) {
                        ...
                        <div style="padding-top: 15px" class="attribute-list">
                            ...
                            <div class="custom-mapping-section">
                                <div style="display: flex; padding-top:15px">
                                    ...
                                    <div>
                                        <button style="background-color: #ee6719" class="btn btn-default btn-circle" 
                                            id="btn-enable-custom-map" type="button" data-toggle="dropdown">
        ...
        XMLMapper.prototype.renderCustomMapper = function () {
                    ...
                    container.append(`
                        <div style="display: flex; padding-top: 10px" class="sample-payload-submit-section">
                            <textarea 
                                ...
                                style="height: 100px; width: 100%; border: none; background-color: transparent; 
                                    border: 1px solid #333" placeholder="Enter the sample payload here" 
                                    type="text" value="">
                            </textarea>
                            <div style="margin-left: 5px;">
                                <button style="background-color: #ee6719" 
                                    class="btn btn-default btn-add-sample-payload">
                                        Submit
                                </button>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; padding-top: 10px" class="sample-payload-submit-section">
                            <textarea
                                ...
                                style="height: 100px; width: 100%; border: none; 
                                    ...
                                    placeholder="Enter the sample payload here" type="text" value="">
                            </textarea>
                            <div style="margin-left: 5px;">
                                <button
            ...
            if (config.mapping.samplePayload.length > 0 || config.mapping.payload.length > 0) {
                ...
                container.append(`
                    <div style="border: 1px solid #333; padding: 5px; margin-top: 5px;" 
                        class="parsed-representation-container">
                        ...
                        .append(`
                            <div style="width: 100%; padding-bottom: 5px" class="attribute-map">
                                <label 
                                    ...
                                    class=""
                                    id="" 
                                    for="index-${key.replaceAll(/\//g, '-')}"
                                >
                                    ${key}
                                </label>
                                <input 
                                    disabled 
                                    id="index-${key.replaceAll(/\//g, '-')}" 
                                    style="width: 100%; border: none; background-color: transparent; 
                                        border-bottom: 1px solid #333" 
                                    placeholder="" type="text" value="${config.mapping.attributes[key]}"
                                >
                            </div>
                        `)
                });
            ...
            container.find('#source-mapper-attribute-dropdown>.dropdown-item')
                .on('click', function (evt) {
                    ...
                    if (config.mapping.properties['enclosing.element'] 
                        ...
                        enclosedElementPath = config.mapping.properties['enclosing.element']
                                                                        .value.substr(2).split('/');
            ...
            container.find('.parsed-representation-container>span.ok-to-clear').popover({
                ...
                template: '<div style="width: fit-content; background-color: #3a3a3a" ' +
        ...
        XMLMapper.prototype.generateHTMLFromXML = function (xmlObject, indent, id) {
            ...
            for (var i = 0; i < xmlObject.childElementCount; i++) {
                ...
                if (xmlObject.children[i].childElementCount > 0) {
                    ...
                    content += `<span id="custom-map-val-${key}" 
                ...
                content += `${
                        xmlObject.children[i].childElementCount > 0 ? indent : ''}&lt;/${xmlObject.children[i].tagName
                }&gt;<br/>`;
            }
