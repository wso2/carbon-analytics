    ...
    function (require, $, _, log, Alerts) {
        ...
        JSONMapper.prototype.renderCustomMapper = function () {
                    ...
                    container.append(`
                        <div style="display: flex; padding-top: 10px" class="sample-payload-submit-section">
                            <textarea
                                ...
                                placeholder="Enter the sample payload here"
                                type="text"
                                value=""></textarea>
                    ...
                    container.append(`
                        <div style="display: flex; padding-top: 10px" class="sample-payload-submit-section">
                            <div>
                                <button
                                    style="background-color: #ee6719"
                                    class="btn btn-default btn-clear-mapping"
                                >
                                    Clear
                                </button>
                            </div>
            ...
            if (config.mapping.samplePayload.length > 0 || config.mapping.payload.length > 0) {
                ...
                container.append(`
                    <div 
                        style="border: 1px solid #333; padding: 5px; margin-top: 5px;" 
                    ...
                    <div 
                        id="source-mapper-attribute-dropdown" 
                        style="left: 150px" 
            ...
            if ( self.__mapperData.namespace === 'sourceMapper' && Object.keys(config.mapping.attributes).length > 0) {
                container.append('' +
                    '<div style="margin: 15px 0 10px 0">Mapped attributes</div>' +
        ...
        JSONMapper.prototype.generateSinkPayload = function (jsonObject, id) {
            ...
            switch (typeof jsonObject) {
                ...
                case "number":
                    content += `${
                        attribIndex > -1 ? Object.keys(config.mapping.attributes)[attribIndex] : jsonObject 
                    }`
                    break;
                case "string":
                    content += `"${
