...
public class SiddhiAppCreatorTestCase {
    ...
    @Test
    public void testAppCreation1() {
//        SPSiddhiAppCreator appCreator = new SPSiddhiAppCreator();
//        String queryTemplate = "@App:name(${appName}) @source(type='http', receiver"
...
//        List<String> generatedQueryList = appCreator.generateQueryList(queryTemplate, "SiddhiApp", "001", 4);
//
//        String expected = "@App:name(SiddhiApp-0) @source(type='http', receiver"
//                + ".url='http://localhost:9055/endpoints/stockQuote', @map(type='xml')) \n"
//                + "Define stream stockStream(symbol string, price float, quantity int, tier string); \n"
//                + "@source(type='http', receiver.url='http://localhost:9055/endpoints/trigger', @map(type='xml'))\n"
//                + "Define stream companyTriggerStream(symbol string);\n"
...
//                + "select * \n"
//                + "insert into companyTriggerInternalStream;\n";
////        Assert.assertEquals(generatedQueryList.get(0), expected);
    }

    @Test
    public void testAppCreation2() {
