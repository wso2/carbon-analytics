...
public class StormOutputStreamListener extends StreamCallback implements EventProducer {
    ...
    public StormOutputStreamListener(String siddhiStreamName, EventJunction eventJunction, ExecutionPlanConfiguration executionPlanConfiguration, int tenantId) {
        ...
        if (statisticsEnabled) {
            statisticsMonitor = StormProcessorValueHolder.getEventStatisticsService().getEventStatisticMonitor(tenantId, StormProcessorConstants.EVENT_PROCESSOR, executionPlanConfiguration.getName(), eventJunction.getStreamDefinition().getStreamId() +" ("+siddhiStreamName+")");
        }
        if (traceEnabled) {
            this.tracerPrefix = "TenantId=" + tenantId + " : " + StormProcessorConstants.EVENT_PROCESSOR + " : " + executionPlanConfiguration.getName() + "," + eventJunction.getStreamDefinition().getStreamId() +" ("+siddhiStreamName+"), after processing " + System.getProperty("line.separator");
        }
    }
