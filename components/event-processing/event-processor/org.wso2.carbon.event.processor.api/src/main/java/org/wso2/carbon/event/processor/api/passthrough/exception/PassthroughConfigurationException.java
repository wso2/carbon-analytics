...
public class PassthroughConfigurationException extends RuntimeException {
    ...
    public PassthroughConfigurationException(String message) {
        super(message);
    }

    public PassthroughConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }

    public PassthroughConfigurationException(Throwable cause) {
        super(cause);
    }
}
