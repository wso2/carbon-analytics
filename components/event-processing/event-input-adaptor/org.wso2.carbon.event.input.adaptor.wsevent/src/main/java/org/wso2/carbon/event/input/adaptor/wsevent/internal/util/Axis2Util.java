...
package org.wso2.carbon.event.input.adaptor.wsevent.internal.util;
...
public final class Axis2Util {
    ...
    public static AxisService registerAxis2Service(
        ...
        String topicNameWithoutSlash = inputEventMessageConfiguration.getInputMessageProperties().get(WSEventAdaptorConstants.ADAPTOR_MESSAGE_TOPIC_NAME).replaceAll("/", "");
    ...
    public static void removeOperation(
        ...
        if (messageReceiver.removeEventAdaptorListener(subscriptionId)) {
            axisService.removeOperation(new QName("", inputEventMessageConfiguration.getInputMessageProperties().get(WSEventAdaptorConstants.ADAPTOR_MESSAGE_TOPIC_NAME).replaceAll("/", "")));
        }
