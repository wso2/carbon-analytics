...
import org.wso2.carbon.event.input.adaptor.wsevent.local.WSEventLocalEventAdaptorType;


public class WSEventLocalEventAdaptorFactory implements InputEventAdaptorFactory {

    @Override
    public AbstractInputEventAdaptor getEventAdaptor() {
        return WSEventLocalEventAdaptorType.getInstance();
    }
}
