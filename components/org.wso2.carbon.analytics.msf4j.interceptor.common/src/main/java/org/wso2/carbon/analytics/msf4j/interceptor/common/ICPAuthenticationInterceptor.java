...
@Component(
        service = ICPAuthenticationInterceptor.class,
        immediate = true
)
public class ICPAuthenticationInterceptor implements RequestInterceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(ICPAuthenticationInterceptor.class);
