...
public class EventStreamTemplateDeployerValueHolder {
    ...
    /*public static void setEventStreamDeployerService(EventStreamDeployer eventStreamDeployer) {
        EventStreamTemplateDeployerValueHolder.eventStreamdeployerService = eventStreamDeployer;
    }

    public static EventStreamDeployer getEventStreamDeployerService() {
        return EventStreamTemplateDeployerValueHolder.eventStreamdeployerService;
    }*/
