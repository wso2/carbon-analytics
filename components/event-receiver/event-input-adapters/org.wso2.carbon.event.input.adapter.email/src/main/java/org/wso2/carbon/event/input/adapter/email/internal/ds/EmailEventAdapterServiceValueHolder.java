...
import org.wso2.carbon.event.input.adapter.email.internal.LateStartAdapterListener;
...
public final class EmailEventAdapterServiceValueHolder {
    ...
    private static final org.apache.commons.logging.Log log = LogFactory.getLog(EmailEventAdapterServiceDS.class);
    ...
    public static void registerConfigurationContextService(
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    log.info("Email input event adapter waiting for dependent configurations to load");
                    Thread.sleep(EmailEventAdapterConstants.AXIS_TIME_INTERVAL_IN_MILLISECONDS * 4);
