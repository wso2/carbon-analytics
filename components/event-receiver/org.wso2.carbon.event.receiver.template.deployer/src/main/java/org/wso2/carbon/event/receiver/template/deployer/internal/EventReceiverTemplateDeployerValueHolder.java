...
public class EventReceiverTemplateDeployerValueHolder {
    ...
    public static void setEventReceiverService(EventReceiverService eventReceiverService) {
        EventReceiverTemplateDeployerValueHolder.eventReceiverService = eventReceiverService;
    }

    public static EventReceiverService getEventReceiverService() {
        return EventReceiverTemplateDeployerValueHolder.eventReceiverService;
    }

    public static void setRegistryService(RegistryService registryService) {
        EventReceiverTemplateDeployerValueHolder.registryService = registryService;
    }
