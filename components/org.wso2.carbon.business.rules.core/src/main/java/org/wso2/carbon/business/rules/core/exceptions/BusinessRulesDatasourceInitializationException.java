...
public class BusinessRulesDatasourceInitializationException extends RuntimeException {
     ...
     */
    public BusinessRulesDatasourceInitializationException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public BusinessRulesDatasourceInitializationException(String message, Throwable cause) {
        super(message, cause);
    }
}
