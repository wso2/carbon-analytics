...
public class BusinessRulesApi implements Microservice {
    ...
    @io.swagger.annotations.ApiOperation(value = "Deletes a business rule",
            notes = "Deletes the business rule that has the given ID",
            response = void.class, tags = {"business-rules",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = void.class),

            @io.swagger.annotations.ApiResponse(code = 404, message = "Business rule not found",
                    response = void.class)})
    public Response deleteBusinessRule(@ApiParam(value = "ID of the business rule to be deleted",
    ...
    @io.swagger.annotations.ApiOperation(value = "Returns list of business rule instances",
            notes = "Gets available list of business rule instances", response = Object.class,
            responseContainer = "List", tags = {"business-rules",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation",
                    response = Object.class, responseContainer = "List")})
    ...
    @io.swagger.annotations.ApiOperation(
            value = "Returns a rule template",
            notes = "Gets the rule template that has the given ID, which is available under the template " +
                    "group with the given ID",
            response = Object.class,
            tags = {"rule-templates",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation", response = Object.class)})
    public Response getRuleTemplate(
    ...
    @Produces({"application/json"})
    @io.swagger.annotations.ApiOperation(value = "Returns template groups", notes = "Gets available template groups",
            response = Object.class, responseContainer = "List", tags = {"template-groups",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "successful operation",
                    response = Object.class, responseContainer = "List")})
