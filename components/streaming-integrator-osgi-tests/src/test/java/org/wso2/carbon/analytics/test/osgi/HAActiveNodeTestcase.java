...
//import org.wso2.carbon.streaming.integrator.core.model.OutputSyncTimestampCollection;
//
//import java.net.URI;
...
//        Assert.assertEquals(nodeInfo.getNodeId(), "wso2-si");
//        Assert.assertEquals(nodeInfo.getGroupId(), "si");
//
