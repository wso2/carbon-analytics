...
public class ThriftEventBundle implements org.apache.thrift.TBase<ThriftEventBundle, ThriftEventBundle._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftEventBundle> {
  ...
  private _Fields optionals[] = {_Fields.SESSION_ID,_Fields.EVENT_NUM,_Fields.INT_ATTRIBUTE_LIST,_Fields.LONG_ATTRIBUTE_LIST,_Fields.DOUBLE_ATTRIBUTE_LIST,_Fields.BOOL_ATTRIBUTE_LIST,_Fields.STRING_ATTRIBUTE_LIST,_Fields.ARBITRARY_DATA_MAP_MAP};
  ...
  public ThriftEventBundle(ThriftEventBundle other) {
    ...
    if (other.isSetArbitraryDataMapMap()) {
      Map<Integer,Map<String,String>> __this__arbitraryDataMapMap = new HashMap<Integer,Map<String,String>>(other.arbitraryDataMapMap.size());
